              ...
              {isLoading ? (
                ...
                filteredModes.map((mode: any, index: number) => (
                  <tr key={mode.id} className={`border-b border-[#E5E7EB] ${index % 2 === 0 ? 'bg-[#F9F9F9]' : 'bg-white'} hover:bg-blue-50`}>
                    <td className="px-3 py-2.5 border-r border-[#E5E7EB] text-center font-bold">{mode.id}</td>
                    ...
                    <td className="px-3 py-2.5 border-r border-[#E5E7EB] text-gray-600">{mode.description || '-'}</td>
