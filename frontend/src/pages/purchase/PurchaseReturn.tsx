        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 flex flex-col h-full">
          ...
          <div className="bg-gray-100 px-4 py-3 border-b border-gray-200 flex flex-col md:flex-row justify-between items-start md:items-center gap-3 md:gap-0">
            <h3 className="font-bold text-sm flex items-center gap-2 uppercase">
              <List size={16} className="text-black font-bold" /> PURCHASED ITEMS TO RETURN
            </h3>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button onClick={() => navigate('/reports/purchase-return')} className="bg-white border border-gray-300 hover:bg-gray-50 text-blue-600 font-bold py-1 px-3 rounded text-xs flex items-center gap-1 shadow-sm">
                ...
                {returnItems.length === 0 ? (
                  ...
                  returnItems.map((item, index) => (
                    <tr key={item.id} className="border-b border-gray-200 hover:bg-gray-50">
                      ...
                      <td data-label="Pur Qty" className="px-4 py-2 border-r border-gray-200 text-center font-bold text-black font-bold">
                        {item.quantity}
                      </td>
          ...
          <div className="flex-shrink-0 mt-auto">
            ...
            <div>
              <label className="block text-[13px] font-bold text-black font-bold uppercase mb-1">Total Debit / Claim Amount</label>
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col transform transition-all scale-100">
            ...
            <div className="p-6 text-center">
              <div className="bg-orange-50 text-orange-800 p-4 rounded-lg mb-6 shadow-sm border border-orange-100">
                <p className="font-bold text-[15px]">Claim Amount: {Number(pendingSavePayload?.totalAmount || 0).toFixed(2)}</p>
