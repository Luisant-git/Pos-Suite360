    ...
    <div className="bg-[#F8FAFC] min-h-[calc(100vh-64px)] p-4">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex gap-2">
          <button onClick={() => navigate('/purchase')} className="bg-[#EFF6FF] text-[#2563EB] font-bold text-[13px] px-4 py-2 rounded border border-[#BFDBFE] hover:bg-[#DBEAFE] flex items-center gap-1 transition-colors">
            Purchase Hub
          </button>
          ...
          <div className="p-3 border-b border-[#E2E8F0] grid grid-cols-1 md:grid-cols-3 gap-2">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="w-full px-2 py-1.5 border border-[#CBD5E1] rounded text-[12px] outline-none focus:border-[#3B82F6]"
              />
              <button className="bg-[#E11D48] hover:bg-[#BE123C] text-white px-3 rounded flex items-center justify-center transition-colors">
                <Filter size={14} />
              </button>
            </div>
          </div>
