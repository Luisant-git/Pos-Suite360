...
import { Save, Trash2, RotateCcw, FileText, X } from 'lucide-react';
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 flex flex-col h-full">
          ...
          <div className="bg-gray-100 px-4 py-2 border-b border-gray-200 flex justify-between items-center">
            <h3 className="font-bold text-sm flex items-center gap-2 uppercase">
              <span className="text-gray-500">grid</span> SOLD ITEMS TO RETURN (RESTOCKED BACK TO INVENTORY)
            </h3>
            <div className="flex items-center gap-2">
              ...
              <span className="bg-red-500 text-white text-xs font-bold px-2 py-1 rounded-full ml-2 shadow-sm">{returnItems.length} Items</span>
            </div>
          </div>
