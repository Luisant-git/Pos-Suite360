...
const SalesView = () => {
  ...
  if (isLoading) {
    return <div className="p-8 text-center text-black font-bold">Loading invoice details...</div>;
  }
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-4">
          <button 
            ...
            className="p-2 bg-white border border-gray-300 rounded hover:bg-gray-50 text-black font-bold transition-colors"
          >
            <ArrowLeft size={18} />
          </button>
          <div>
        ...
        <div className="flex gap-2">
          ...
          <button 
            ...
            className="flex items-center gap-2 bg-[#22C55E] border border-[#22C55E] text-white hover:bg-[#16A34A] px-4 py-2 rounded font-bold text-[13px] transition-colors shadow-sm"
          >
        ...
        <div className="w-[320px] space-y-6">
          <div className="bg-white rounded shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-4 space-y-3 text-[14px]">
              ...
              <div className="flex justify-between items-center text-black font-bold border-b border-gray-100 pb-3">
                <span>Tax</span>
